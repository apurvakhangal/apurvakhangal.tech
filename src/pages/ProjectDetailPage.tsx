...
import { AYASHIELD_CONTENT } from "@/data/project-pages/ayashield";
import { EDURA_CONTENT } from "@/data/project-pages/edura";
import { BURGER_KING_CASE_STUDY } from "@/data/project-pages/burgerKing";

// Stable animation variant — shared across all sections to avoid inline object allocation
const SECTION_ANIM = {
